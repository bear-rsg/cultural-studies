# Generated by Django 3.2.16 on 2023-02-21 17:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_range_from', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='year range (from)')),
                ('year_range_to', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='year range (to)')),
                ('date_details', models.CharField(blank=True, max_length=1000, null=True)),
                ('admin_notes', models.TextField(blank=True, null=True)),
                ('meta_created_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('meta_lastupdated_datetime', models.DateTimeField(auto_now=True, verbose_name='Last Updated')),
                ('parent_entity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='researchdata.entity')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_year_range_from', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='start year range (from)')),
                ('start_year_range_to', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='start year range (to)')),
                ...
                ('end_year_range_from', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='end year range (from)')),
                ('end_year_range_to', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='end year range (to)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_year_range_from', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='created year range (from)')),
                ('created_year_range_to', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='created year range (to)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_year_range_from', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='birth year range (from)')),
                ('birth_year_range_to', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='birth year range (to)')),
                ...
                ('death_year_range_from', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='death year range (from)')),
                ('death_year_range_to', models.IntegerField(blank=True, help_text='(if specific date not known)', null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2030)], verbose_name='death year range (to)')),
                ('admin_notes', models.TextField(blank=True, null=True)),
                ('meta_created_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('meta_lastupdated_datetime', models.DateTimeField(auto_now=True, verbose_name='Last Updated')),
            ],
        ...
        migrations.AddField(
            model_name='item',
            name='finding_aid',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='researchdata.slitemfindingaid'),
        ),
        migrations.AddField(
            model_name='item',
            name='language',
            field=models.ManyToManyField(blank=True, to='researchdata.SlLanguage'),
        ),
        migrations.AddField(
            model_name='item',
            name='media',
            field=models.ManyToManyField(blank=True, to='researchdata.SlItemMedia'),
        ),
        migrations.AddField(
            model_name='item',
            name='parent_item',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='researchdata.item'),
        ),
        migrations.AddField(
            model_name='item',
            name='publication_status',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='researchdata.slitempublicationstatus'),
        ),
        migrations.AddField(
            model_name='item',
            name='type',
            field=models.ManyToManyField(blank=True, to='researchdata.SlItemType'),
        ),
        migrations.AddField(
            model_name='event',
            name='activity',
            field=models.ManyToManyField(blank=True, to='researchdata.SlEventActivity'),
        ),
        migrations.AddField(
            model_name='event',
            name='frequency',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='researchdata.sleventfrequency'),
        ),
        migrations.AddField(
            model_name='event',
            name='language',
        ...
        migrations.AddField(
            model_name='event',
            name='type',
            field=models.ManyToManyField(blank=True, to='researchdata.SlEventType'),
        ),
        migrations.CreateModel(
            name='EntityHistory',
            fields=[
